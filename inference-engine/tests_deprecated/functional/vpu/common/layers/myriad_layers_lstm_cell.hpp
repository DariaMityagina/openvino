...
<net batch="1" name="ctpn" version="4">
  <layers>
    ...
    <layer id="38" name="RNNOutput" precision="FP16" type="TensorIterator">
      ...
      <port_map>
        <input external_port_id="0" internal_layer_id="0" internal_port_id="0" axis="1" start="0" end="-1" stride="1"/>
        ...
        <output external_port_id="3" internal_layer_id="2" internal_port_id="1" axis="1" start="0" end="-1" stride="1"/>
      </port_map>
      <back_edges>
...
<net batch="1" name="ctpn" version="4">
  <layers>
    ...
    <layer id="38" name="RNNOutput" precision="FP16" type="TensorIterator">
      ...
      <port_map>
        <input external_port_id="0" internal_layer_id="0" internal_port_id="0" axis="0" start="1" end="0" stride="-1"/>
        <input external_port_id="1" internal_layer_id="1" internal_port_id="1"/>
        <input external_port_id="2" internal_layer_id="1" internal_port_id="2"/>
        <output external_port_id="3" internal_layer_id="2" internal_port_id="1" axis="0" start="1" end="0" stride="-1"/>
      </port_map>
      <back_edges>
        <edge from-layer="1" from-port="5" to-layer="1" to-port="1"/>
        <edge from-layer="1" from-port="6" to-layer="1" to-port="2"/>
  ...
  <layers>
    ...
    <layer id="38" name="lstm_fused_cell/BlockLSTM/TensorIterator" precision="FP16" type="TensorIterator">
      ...
      <port_map>
        ...
        <input external_port_id="2" internal_layer_id="1" internal_port_id="2"/>
        <output external_port_id="3" internal_layer_id="2" internal_port_id="1" axis="1" start="0" end="-1" stride="1"/>
        <output external_port_id="4" internal_layer_id="3" internal_port_id="1" axis="1" start="0" end="-1" stride="1"/>
        <output external_port_id="5" internal_layer_id="4" internal_port_id="1" axis="1" start="0" end="-1" stride="1"/>
      </port_map>
      <back_edges>
        <edge from-layer="1" from-port="5" to-layer="1" to-port="1"/>
        <edge from-layer="1" from-port="6" to-layer="1" to-port="2"/>
